    ...
    <div className="space-y-1">
      ...
      <div className="relative">
        <input
          ...
          className={`block w-full rounded-xl border border-border bg-card px-3 py-2.5 pr-10 text-sm text-foreground shadow-sm placeholder:text-muted focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 transition-all ${error ? 'border-red-500' : ''} ${className}`}
          {...props}
        />
        <button
          type="button"
